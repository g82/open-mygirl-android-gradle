/**
 ...
 first written by seckceed 03.15.2013
 */
...
import com.seokceed.mygirl.contents.ContentsData;
import com.seokceed.mygirl.contents.RequestContents;
import com.seokceed.mygirl.contents.ResultsContents;
import com.seokceed.mygirl.dialog.ExitAdDialog;
import com.seokceed.mygirl.dialog.OnContentsSelectListener;
import com.seokceed.mygirl.image.ImageModify;
import com.seokceed.mygirl.image.MediaFileUtil;
...
//				EasyTracker.getTracker().sendEvent("user_action", "image_process", "failed", 0l);
        ...
        protected ResultsContents doInBackground(RequestContents... params) {
            ...
            //kitkat path value.
            //content://com.android.providers.media.documents/document/image%3A27880

            if (!path.contains(".png") && !path.contains(".jpg")) {

                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
                    request.setImage_uri(path);
                } else {
            ...
            if (imageModify == null) {
                imageModify = new ImageModify(MainImageActivity.this);
            }
